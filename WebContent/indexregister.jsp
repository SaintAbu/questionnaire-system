	...
	<div id="mainFrame">
					...
					<div id="bs_bannerright">
						...
						<div class="bs_nav">
							<div class="bs_navleft">
								<li><span id="username"> </span>您好！今天是 <script>
							...
							<div class="bs_navright">
								<span class="icon_no hand"
									onclick='top.Dialog.confirm("确定要退出系统吗",function(){window.location="land.jsp"});'>退出系统</span>
								<div class="clear"></div>
							</div>
							<div class="clear"></div>
						</div>
								...
								<div id="lbox_middleright">
									<div id="bs_left">
										<IFRAME scrolling="no" width="100%" frameBorder=0 id=frmleft
											name=frmleft src="leftPages/zhuce.html"
								...
								<div id="rbox_middleright">
									<div id="bs_right">
										<IFRAME scrolling="yes" width="100%" height="100%"
											frameBorder=0 id=frmright name=frmright src="register.jsp"
											allowTransparency="true"> </IFRAME>
									</div>
								</div>
							</div>
		...
		<div id="fbox">
			<div id="bs_footcenter">
				<div id="bs_footleft">
					<div id="bs_footright">业务咨询电话：0311-85813216
						技术服务电话：13028644840 18330107787</div>
				</div>
			</div>
		</div>
	</div>
