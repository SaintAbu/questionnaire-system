...
<table border="1"
		...
		<tbody>
    		...
    		<td width="77"><div align="center">机构代码</div></td>
    		...
    		<td width="65"><div align="center">审核</div></td>
    		</tr>
		</table>
			<%
 String Grade=new String(session.getAttribute("Grade").toString().getBytes("ISO-8859-1"),"UTF-8");
	...
	String sql3="select * from register,unit where  register.Grade=unit.Grade and unit.yitijiao='0'and unit.xsshenhe='0'";
   ...
   <% 
				...
				<tr>
					...
					<td width="65"><div align="center"><a href=checks.jsp?getName=<%=rs.getString(18) %>>审核</a></div></td>
					</tr>
				</table>							
